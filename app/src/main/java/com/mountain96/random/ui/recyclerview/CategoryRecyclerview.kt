...
abstract class CategoryRecyclerview() : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    lateinit var db : AppDatabase
    lateinit var activity: FragmentActivity
    lateinit var resources: Resources
    lateinit var adapter: FoodsRecyclerView
    ...
    protected abstract fun loadCategoryList()
